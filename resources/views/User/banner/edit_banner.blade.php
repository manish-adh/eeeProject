...
<body>
    ...
    <div class="container">
    <form class="row g-3 " action="{{url('update/banner',$banner->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="col-md-4">
          ...
          <div class="col-md-4">
            ...
            <input type="date" class="form-control" name="Start_date" value="{{$banner->Start_date}}" required>

          </div>
          <div class="col-md-4">
            <label for="validationCustom01" class="form-label">End_date</label>
            <input type="date" class="form-control" name="End_date" value="{{$banner->End_date}}" required>
